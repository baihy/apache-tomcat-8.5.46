...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        for (int i = 0; i < children.length; i++) {
            // 启动子节点。
            // 注意：实现org.apache.catalina.core.ContainerBase抽象类的类有：StandardEngine，StandardHost，StandardContext。
            // 且在这三个类中的startInternal()方法，调用父类ContainerBase中的startInternal方法，其他的子类没有调用父类的方法。
